...
public class RestFactory implements ApiFactory {
    ...
    @Override
    public HttpResponse executeTarget(ApiMethod apiMethod, RequestDTO requestDTO,
...
//        long startTime = System.currentTimeMillis();
    ...
    public HttpResponse invokePost(String url, Map<String, String> headers, List<NameValuePair> params,
    ...
    public HttpResponse invokePut(String url, Map<String, String> headers, List<NameValuePair> params,
                                  String type, String body, SSLConnectionSocketFactory sslConnectionFactory, int timeout)
            throws IOException {
    ...
    public HttpResponse invokeDelete(String url, Map<String, String> headers, String body,
                                     SSLConnectionSocketFactory sslConnectionFactory, int timeout) throws IOException {
        HttpClient client = getClient(sslConnectionFactory, timeout);
    ...
    public HttpResponse invokePatch(String url, Map<String, String> headers, String body,
                                    SSLConnectionSocketFactory sslConnectionFactory, int timeout) throws IOException {
        HttpClient client = getClient(sslConnectionFactory, timeout);
    ...
    private HttpClient getClient(SSLConnectionSocketFactory sslConnectionFactory, int timeout) {
        HttpClient client;
